...
with st.sidebar:
    st.title("Dashboard")
    st.markdown("Analytics view for  Airflow aggregation outputs.")
    st.divider()
    ...
    st.divider()
    st.markdown("### Notes")
    st.caption("This UI only reads output from aggregation in pipeline.")
...
st.markdown(
    '<div class="small-note">A quick summary across all aggregation outputs.</div>',
    unsafe_allow_html=True
)
...
# =========================================================
with tab1:
    st.subheader("Job Count Aggregation")
...
# =========================================================
with tab2:
    st.subheader("Skills Count Aggregation")
...
# =========================================================
with tab3:
    st.subheader("Job Description Word Cloud Aggregation")
...
# =========================================================
with tab4:
    st.subheader("Regression Aggregation")
...
# =========================================================
with tab5:
    st.subheader("Topic Modeling Aggregation")
    

    st.markdown("**Extracted topics**")
    st.code(read_text(TOPICS_TXT), language="text")
